		...
		<div id="signup" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:700px;">
				<div class="modal-header">
					...
					<form method="post">
						...
						<input type="text" name="zipcode"  pattern="[0-9]{5}" placeholder="ZIP Code" required maxlength="6">
						<input type="text" name="mobile"  pattern="[0-9]{10}" placeholder="Enter 10-digit number" maxlength="11">
...
<div id="container">
	...
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">THE SHOEHUB 2023 </p>
		</div>

			<div id="foot">
				<h4>Links</h4>
					<ul>
						<a href="https://www.facebook.com/theshoehub0"><li>Facebook</li></a>
						<a href="https://twitter.com/the_shoehub"><li>Twitter</li></a>
