							...
							<?php
								...
								if(empty($_POST['mobile'])){
									...
									elseif (!preg_match("/^[0-9]{10}$/", $mobile)) {
										$mobileNumberError = "Invalid mobile number format";
									}
								}
						?>
				<div id="account">
					<form method="POST" action="function/edit_customer.php">
						...
						<h3>Edit My Account...</h3>
							<table>
								...
								<tr>
									<td>Mobile Number:</td><td><input type="tel" name="mobile" placeholder="Mobile Number" value="<?php echo $mobile;?>" maxlength="11"></td>
								</tr>
								<tr>
									<td>Telephone Number:</td><td><input type="tel" name="telephone" placeholder="Telephone Number" value="<?php echo $telephone;?>" maxlength="8"></td>
								</tr>
								<tr>
